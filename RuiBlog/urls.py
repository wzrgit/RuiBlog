...
urlpatterns = [
    ...
    path('management/post/upload_cover', mgr_posts.upload_post_cover, name='upload_post_cover'),
    path('management/post/get_covers', mgr_posts.get_post_covers, name='get_post_covers'),
    path('management/post/del_cover', mgr_posts.del_post_cover, name='delete_post_cover'),
